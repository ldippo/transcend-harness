...
Tests are the contract that lets agents change code confidently. fable makes the
...
Whatever the strategy, fable records the project's `test_cmd` so advisory and
